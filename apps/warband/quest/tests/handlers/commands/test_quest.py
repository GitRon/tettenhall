...
from apps.warband.quest.handlers.commands.quest import handle_accept_quest, handle_create_new_quest
from apps.warband.quest.messages.commands.quest import AcceptQuest, CreateNewQuest
...
def test_handle_accept_quest_musters_as_many_defenders_as_the_difficulty_asks_for():
    ...
    with mock.patch("apps.warband.quest.handlers.commands.quest.random.randint", return_value=4):
        result = handle_accept_quest(
            context=AcceptQuest(
...
def test_handle_accept_quest_musters_no_more_defenders_than_the_target_has():
    ...
    with mock.patch("apps.warband.quest.handlers.commands.quest.random.randint", return_value=7):
        result = handle_accept_quest(
            context=AcceptQuest(
                accepting_faction=accepting_faction,
                quest=quest,
...
def test_handle_accept_quest_leaves_the_targets_casualties_at_home():
    ...
    with mock.patch("apps.warband.quest.handlers.commands.quest.random.randint", return_value=5):
        result = handle_accept_quest(
            context=AcceptQuest(
                accepting_faction=accepting_faction,
                quest=quest,
