...
from apps.warband.faction.messages.events.quest import NewBulletinBoardQuestRequired
from apps.warband.quest.messages.commands.quest import CreateNewQuest
