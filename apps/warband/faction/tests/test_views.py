...
def test_faction_detail_view_hides_factions_of_other_savegames(logged_in_client, current_savegame):
    ...
    response = logged_in_client.get(reverse("warband:faction-detail-view", kwargs={"pk": foreign_faction.id}))
...
def test_faction_detail_view_says_why_the_attack_is_gone(
    ...
    response = logged_in_client.get(reverse("warband:faction-detail-view", kwargs={"pk": untouched_rival.id}))
...
def test_faction_detail_view_says_nothing_about_a_committed_war_band_on_a_defeated_faction(
    ...
    response = logged_in_client.get(reverse("warband:faction-detail-view", kwargs={"pk": defeated_faction.id}))
...
def test_faction_item_list_view_hides_factions_of_other_savegames(logged_in_client, current_savegame):
    ...
    response = logged_in_client.get(reverse("warband:faction-item-list-htmx", kwargs={"pk": foreign_faction.id}))
...
def test_faction_warrior_list_view_hides_factions_of_other_savegames(logged_in_client, current_savegame):
    ...
    response = logged_in_client.get(reverse("warband:faction-warrior-list-htmx", kwargs={"pk": foreign_faction.id}))
...
def test_faction_captured_warrior_list_view_does_not_mark_a_rival_as_the_players_own(
    ...
    response = logged_in_client.get(
        reverse("warband:faction-captured-warrior-list-htmx", kwargs={"pk": rival_faction.id})
    )
...
def test_faction_captured_warrior_list_view_hides_factions_of_other_savegames(logged_in_client, current_savegame):
    ...
    response = logged_in_client.get(
        reverse("warband:faction-captured-warrior-list-htmx", kwargs={"pk": foreign_faction.id})
    )
...
def test_draft_warrior_from_fyrd_view_drafts_a_warrior(logged_in_client, current_savegame, queuebie_registry):
    ...
    response = logged_in_client.post(reverse("warband:faction-draft-warrior-from-fyrd-view", kwargs={"pk": faction.id}))
...
def test_draft_warrior_from_fyrd_view_hides_factions_of_other_savegames(
    ...
    response = logged_in_client.post(
        reverse("warband:faction-draft-warrior-from-fyrd-view", kwargs={"pk": foreign_faction.id})
    )
...
def test_draft_warrior_from_fyrd_view_cannot_draft_into_a_rival_faction(
    ...
    response = logged_in_client.post(
        reverse("warband:faction-draft-warrior-from-fyrd-view", kwargs={"pk": rival_faction.id})
    )
...
def test_recruit_pub_mercenary_view_hides_the_pub_of_another_savegame(
    ...
    response = logged_in_client.post(reverse("warband:pub-mercenary-recruit-view", kwargs={"pk": other_mercenary.id}))
...
def test_recruit_pub_mercenary_view_cannot_hire_a_warrior_outside_the_pub(
    ...
    response = logged_in_client.post(reverse("warband:pub-mercenary-recruit-view", kwargs={"pk": rival_warrior.id}))
...
def test_recruit_pub_mercenary_view_without_a_player_faction(
    ...
    response = logged_in_client.post(reverse("warband:pub-mercenary-recruit-view", kwargs={"pk": mercenary.id}))
...
def test_faction_attack_view_hides_factions_of_other_savegames(
    ...
    response = logged_in_client.post(reverse("warband:faction-attack-view", kwargs={"pk": foreign_faction.id}), data={})
...
def test_faction_attack_view_cannot_attack_the_players_own_faction(
    ...
    """
    response = logged_in_client.post(
        reverse("warband:faction-attack-view", kwargs={"pk": player_faction_ready_to_march.id}), data={}
    )
...
def test_faction_attack_view_cannot_attack_a_defeated_faction(
    ...
    response = logged_in_client.post(
        reverse("warband:faction-attack-view", kwargs={"pk": defeated_faction.id}), data={}
    )
...
def test_faction_attack_view_cannot_march_twice_in_a_month(
    ...
    response = logged_in_client.post(reverse("warband:faction-attack-view", kwargs={"pk": untouched_rival.id}), data={})
...
def test_faction_attack_view_without_an_active_savegame(logged_in_client):
    ...
    response = logged_in_client.post(reverse("warband:faction-attack-view", kwargs={"pk": faction.pk}), data={})
...
def test_monthly_cost_overview_hides_factions_of_other_savegames(logged_in_client, current_savegame):
    ...
    response = logged_in_client.get(reverse("warband:faction-monthly-costs-view", kwargs={"pk": foreign_faction.id}))
...
def test_faction_shop_item_list_view_shows_the_available_items(logged_in_client, current_savegame):
    ...
    response = logged_in_client.get(
        reverse("warband:shop-item-list-htmx", kwargs={"pk": current_savegame.player_faction.id})
    )
...
def test_faction_shop_item_list_view_hides_factions_of_other_savegames(logged_in_client, current_savegame):
    ...
    response = logged_in_client.get(reverse("warband:shop-item-list-htmx", kwargs={"pk": foreign_faction.id}))
...
def test_faction_detail_view_offers_an_undefended_town(logged_in_client, current_savegame, undefended_rival):
    response = logged_in_client.get(reverse("warband:faction-detail-view", kwargs={"pk": undefended_rival.id}))
...
def test_faction_occupy_view_takes_the_town(logged_in_client, current_savegame, undefended_rival, queuebie_registry):
    ...
    response = logged_in_client.post(reverse("warband:faction-occupy-view", kwargs={"pk": undefended_rival.id}))
...
def test_faction_occupy_view_hides_factions_of_other_savegames(logged_in_client, current_savegame):
    ...
    response = logged_in_client.post(reverse("warband:faction-occupy-view", kwargs={"pk": foreign_faction.id}))
...
def test_resource_bar_htmx_view_renders_the_counters(logged_in_client, current_savegame):
    response = logged_in_client.get(reverse("warband:resource-bar-htmx"))
