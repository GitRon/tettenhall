...
from apps.warband.faction.handlers.commands.quest import handle_offer_quests
from apps.warband.faction.messages.commands.quest import OfferNewQuestsOnBulletinBoard
from apps.warband.faction.messages.events.quest import BulletinBoardQuestsOffered, NewBulletinBoardQuestRequired
...
def test_handle_offer_quests_requests_one_quest_per_drawn_slot():
    ...
    with mock.patch("apps.warband.faction.handlers.commands.quest.random.randrange", return_value=2):
