...
def test_handle_restock_shop_items_requests_weapons():
    ...
    with mock.patch("apps.warband.faction.handlers.commands.faction.random.getrandbits", return_value=1):
...
def test_handle_restock_shop_items_requests_armor():
    ...
    with mock.patch("apps.warband.faction.handlers.commands.faction.random.getrandbits", return_value=0):
        result = handle_restock_shop_items(context=RestockTownShopItems(faction=faction, month=3))
...
def test_handle_restock_shop_items_removes_previous_stock():
    ...
    with (
        mock.patch("apps.warband.faction.handlers.commands.faction.random.randrange", return_value=4),
        mock.patch("apps.warband.faction.handlers.commands.faction.random.getrandbits", return_value=1),
    ):
