...
def test_process_lifts_the_item_by_the_quality_bonus():
    ...
    with mock.patch("apps.warband.item.services.generators.item.base.random.gauss", return_value=2):
...
def test_process_rolls_armor_from_its_own_pool(armor_generator):
    ...
    """
    with mock.patch("apps.warband.item.services.generators.item.base.random.gauss", return_value=1) as mocked_gauss:
...
def test_process_lifts_armor_by_the_quality_bonus():
    ...
    with mock.patch("apps.warband.item.services.generators.item.base.random.gauss", return_value=1):
        result = generator.process()
