...
from apps.warband.skirmish.managers.skirmish_blow import SkirmishBlowManager
...
class SkirmishBlow(models.Model):
    ...
    defense_item_type = models.ForeignKey(
        "warband.ItemType", verbose_name="Armor type", related_name="blows_absorbed", on_delete=models.CASCADE
    )
