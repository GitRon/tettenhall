...
from apps.warband.skirmish.handlers.commands.transaction import handle_warrior_drops_silver
from apps.warband.skirmish.messages.commands.transaction import WarriorDropsSilver
...
def test_handle_warrior_drops_silver_hands_the_rolled_amount_to_the_victor():
    ...
    with mock.patch("apps.warband.skirmish.handlers.commands.transaction.random.gauss", return_value=12.4):
...
def test_handle_warrior_drops_silver_drops_nothing_on_a_zero_roll():
    ...
    with mock.patch("apps.warband.skirmish.handlers.commands.transaction.random.gauss", return_value=-3.0):
        result = handle_warrior_drops_silver(
            context=WarriorDropsSilver(
                skirmish=skirmish, warrior=warrior, gaining_faction=skirmish.attacking_faction, month=3
            )
