...
from apps.skirmish.managers.skirmish_spoil import SkirmishSpoilManager
...
class SkirmishSpoil(models.Model):
    ...
    faction = models.ForeignKey("faction.Faction", verbose_name="Gaining faction", on_delete=models.CASCADE)
    ...
    item = models.ForeignKey("item.Item", verbose_name="Item", null=True, blank=True, on_delete=models.CASCADE)
    warrior = models.ForeignKey(
        "skirmish.Warrior", verbose_name="Taken from", null=True, blank=True, on_delete=models.CASCADE
    )
