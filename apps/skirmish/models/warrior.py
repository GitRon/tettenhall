...
class Warrior(models.Model):
    ...
    weapon = models.ForeignKey(Item, verbose_name='Weapon', related_name='warrior_weapons', on_delete=models.CASCADE)
    armor = models.ForeignKey(Item, verbose_name='Armor', related_name='warrior_armor', on_delete=models.CASCADE)
